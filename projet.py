...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.frameVueCommandes)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 901, 731))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.layoutVueCommandes = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.layoutVueCommandes.setContentsMargins(0, 0, 0, 0)
        self.layoutVueCommandes.setObjectName("layoutVueCommandes")
